...
The functionality offered by wireframesketcher has been re-used completely from the existing tooling, however, some customizations were implemented as described in \Cref{sec:WireframesketcherIntegration}.
