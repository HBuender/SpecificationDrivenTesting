...
\maketitle
\begin{abstract}
Behavior-driven development brings requirement specifications and their test cases closer together by using a ubiquitous language to define requirements that can be mapped to test methods.
Although, frameworks industry-proven tools are able to map from requirement specification to test methods, these methods still need to be implemented manually.
